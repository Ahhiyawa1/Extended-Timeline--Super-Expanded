...
if __name__ == "__main__":
    input_directory = r"D:\Program Files\Steam\steamapps\common\Europa Universalis IV\events"  # Change this to your input mod folder
    output_directory = r"D:\Program Files\Steam\steamapps\common\Europa Universalis IV\events1"  # Change this to your desired output folder
